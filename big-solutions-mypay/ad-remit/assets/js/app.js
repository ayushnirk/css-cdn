...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Show all locations active by default

document.querySelectorAll(".data-center__location").forEach(item => {
  item.classList.add("active");
});

document.querySelectorAll(".hero-1__map-location").forEach(item => {
  item.classList.add("active");
});
